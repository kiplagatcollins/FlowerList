 ...
 <br>
      <div class="container row">
        ...
        <c:if test="${flowers.deleted==0 }">
            ...
            <c:if test="${flowers.quantity>0}">
            <div class="col-sm-3 logopad box list-group">
            <div data-filter="${flowers.name}" data-search="${flowers.name}">
            <img src="data:image/jpg;base64,${flowers.base64image}" class="img media-object" alt="${flowers.name }"/>
            <h4 class="name">${flowers.name }</h4>
            <p>Price <span>Ksh. ${flowers.price }</span></p>
